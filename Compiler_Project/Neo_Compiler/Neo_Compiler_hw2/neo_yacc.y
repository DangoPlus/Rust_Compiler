...
%type  <val> value_decl program primary_expr type_specifier decl_list func_inv_list func_inv
...
: FN_def
| decl_list
| IDENTIFIER '(' func_inv_list ')'
;

func_inv_list
: func_inv 
| '(' func_inv_list ',' func_inv ')'
;
...
declaration
: LET IDENTIFIER '=' value_decl ';'{
	insert( $2, "const", $4 );
}
| LET IDENTIFIER ':' type_specifier '=' value_decl ';'{
	insert( $2, $4, $6 );
}
| LET MUT IDENTIFIER ':' type_specifier '=' value_decl ';'{
	insert( $3, $5, $7 );
}
| LET MUT IDENTIFIER ':' type_specifier ';'{
    insert( $3, $5, "");
}
| LET MUT IDENTIFIER '=' value_decl ';'{
    insert( $3, "", $5);
}
| LET MUT IDENTIFIER ';'{
	insert( $3, "int", "" );
...
| fn_expr IDENTIFIER '(' para_list ')' AR_OP type_specifier compound_stat
{
	insert( $2, "func", $7 );
}
